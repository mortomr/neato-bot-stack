#!/usr/bin/env python3
# THANKS https://github.com/n1kn4x/xv11_lidar_python/blob/main/xv11_lidar_python/xv11_lidar_publisher.py
...
def extract_sweep(buffer):
    ...
    scan.ranges = [0.0] * 360
    #debug:
    print("Publishing scan with first range value:", scan.ranges[0])
